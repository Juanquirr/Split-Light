...
var audio_manager_path: String = "res://lib/AudioManager/AudioManagerInstance.tscn" ## The path to the audio manager scene.
var audio_manage_scene: PackedScene = load(audio_manager_path) ## Loads the audio manage scene so the tool can modify it.
var folder_path: String = "res://Assets/Sounds/Effects/" ## The path to your folder containing your SoundEffect resources.
